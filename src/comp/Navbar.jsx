...
const Navbar = () => {
  return (
    <>
      <div className="nav z-100 overflow-x-hidden sticky  z-10 bg-black top-0 pb-2">
        <div className="navbar flex  w-full p-3">
          ...
          <div className="user flex max-[768px]:text-md text-3xl w-3/12 relative">
            ...
            <Link><i class="fa-solid fa-user  mt-2 ml-5"></i></Link>
        ...
        <div className="undernav h-10 flex">
          ...
          <div className="mobile-menu border-white w-1/12 flex">
            ...
            <div className="hr h-9 bg-white ml-5" style={{ width: "2px" }}></div>
          </div>
          <div className="menu-tab w-10/12 p-2 flex max-[768px]:hidden text-center flex-wrap">
            <Link className='pl-4 max-[768px]:hidden'><h1 >Home</h1></Link>
            <Link className='pl-4 max-[768px]:hidden'><h1>Mobile phone</h1></Link>
            <Link className='pl-4 max-[768px]:hidden'><h1>Hadphone & earphone</h1></Link>
            <Link className='pl-4 max-[768px]:hidden'><h1>Mobile Accersrise</h1> </Link>
            <Link className='pl-4 max-[768px]:hidden'><h1>laptop</h1></Link>
            <Link className='pl-4 max-[768px]:hidden'><h1>printer</h1></Link>
            <Link className='pl-4 max-[768px]:hidden'><h1>Storage Devices</h1></Link>
            <Link className='pl-4 max-[768px]:hidden'><h1>All computer accerioes</h1></Link>
            <Link className='pl-4 max-[768px]:hidden'><h1 className='w-32'>Home appliances</h1></Link>
          </div>
