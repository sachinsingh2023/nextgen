...
const Footer = () => {
  return (
   ...
   <>
   <footer class="bg-grey-400 border-t-2">
    <div class="container p-6 mx-auto">
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    <a href="#">
                        <img class="w-44 h-10" src={logo} alt=""/>
                    </a>
        ...
        <div>
            <p class="text-center text-gray-500 dark:text-gray-400">© sachin singh 2024 - All rights reserved</p>
        </div>
    </div>
</footer></>
  )
