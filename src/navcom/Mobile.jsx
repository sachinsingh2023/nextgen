  ...
  return (
    ...
    <Navbar/>
       <div className="banner1 w- full">
                <img src={"https://i.pinimg.com/originals/ca/e7/2c/cae72ce86998abcadd5051acd91a696b.jpg"} className='w-full max-h-72' alt="" />
...
<div class="m-4 mx-auto max-w-screen-lg rounded-md border border-gray-100 text-gray-600 shadow-md">
  <div class="relative flex h-full flex-col text-gray-600 md:flex-row">
    ...
    <div class="mx-auto flex items-center px-5 pt-1 md:p-8">
      <img class="block h-auto max-w-full rounded-md shadow-lg" src="https://media-ik.croma.com/prod/https://media.croma.com/image/upload/v1667848781/Croma%20Assets/Computers%20Peripherals/Tablets%20and%20iPads/Images/252983_0_jx3ksk.png?tr=w-360" alt="Shop image" />
    </div>
  </div>
</div>
