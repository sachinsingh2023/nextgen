...
const Storage = () => {
  ...
  <Navbar />
      <div className="banner1 w- full">
        <img src={"https://images-eu.ssl-images-amazon.com/images/G/31/img22/Storage/Seagate_OneT-Banner/Banner_Black-1_OT-HDD_1242x450px.jpg"} className='w-full max-h-72' alt="" />
