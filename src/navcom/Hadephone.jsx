...
const Hadephone = () => {
  ...
  <Navbar />
      <div className="banner1 w- full">
        <img src={"https://i0.wp.com/thequill.in/wp-content/uploads/2019/12/Sound-One-V10-headphobe-banner.png?ssl=1"} className='w-full max-h-72' alt="" />
