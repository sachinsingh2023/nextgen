...
import ProductO from '../comp/ProductO'

const HomeApl = () => {
  return (<><Navbar />
    <div className="banner1 w- full">
      <img src={"https://1.bp.blogspot.com/-XmkQtvVbM5w/X4nY35gJ7BI/AAAAAAAAA6Q/_OyTj1z95XEPz3MPRYEKvdRnfRYGZ9ZNwCLcBGAsYHQ/s820/Home%2Bapplinces.jpg"} className='w-full max-h-72' alt="" />

    </div>


    <ProductO />
    <h1 className='text-start text-3xl pl-12' style={{ borderLeft: "5px solid white ", }}>samsung mobile</h1>
    <div className="flex justify-center">
      <div className="topdeals " style={{ width: "80%" }}>
    ...
    <h1 className='text-start text-3xl pl-12' style={{ borderLeft: "5px solid white ", }}>vivo mobile</h1><div className="flex justify-center">
    ...
    <h1 className='text-start text-3xl pl-12' style={{ borderLeft: "5px solid white ", }}>realme mobile</h1>
    <div className="flex justify-center">
      <div className="topdeals " style={{ width: "80%" }}>
